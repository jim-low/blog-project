...
const jimSection = document.getElementById('projects')
const jasonSection = document.getElementById('projects')
const teamSection = document.getElementById('projects')
const sections = [jimSection, jasonSectio, teamSection]
...
for(let i = 0; i < projectsList.length; i++) {
    ...
    jimSection.appendChild(section)
}
